...
public class ParkingsFilterActivity extends BaseAppCompat {
    private TextInputEditText mCountry, mCity, mPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parkings_filter);
        super.SetToolbarTitle("Parkings filter");
        InitializeViews();
        SetFilters();
        InitializeDates();
        ...
        mSearchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetValues();
                ParkingCore.Instance().getBookedDates(mStartDay, mEndDay);
                Intent myIntent = new Intent(ParkingsFilterActivity.this, ListParkingsActivity.class);
    ...
    private void SetFiltersValues() {
        ...
        SetEditTextValue(mCity, mFilterValues[1]);
        SetEditTextValue(mPrice, mFilterValues[2]);
        mStartDateTv.setText(ParkingCore.Instance().getmStartDate());
        mEndDateTv.setText(ParkingCore.Instance().getmEndDate());
    }
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            ...
            if (mDate == 0 )
            {
                ...
                if (mStartDay.after(mEndDay))
                {
                    ...
                    mEndDate = formatTime.format(mEndDay);
                    mEndDateTv.setText(mEndDate);
                    ParkingCore.Instance().setmEndDate(mEndDate);
                }
                mStartDate = formatTime.format(date);
                mStartDateTv.setText(mStartDate);
                ParkingCore.Instance().setmStartDate(mStartDate);
            }
            else if (mDate == 1 )
            {
                mEndDay = date;
